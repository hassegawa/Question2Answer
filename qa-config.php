...
*/
	...
	define('QA_MYSQL_USERNAME', getenv('MYSQL_USERNAME'));
	define('QA_MYSQL_PASSWORD', getenv('MYSQL_PASSWORD'));
	define('QA_MYSQL_DATABASE', getenv('MYSQL_DB_NAME'));

	// define('QA_MYSQL_HOSTNAME', 'db');
	// define('QA_MYSQL_USERNAME', 'question-user');
	// define('QA_MYSQL_PASSWORD', 'QuestionAnswer42');
	// define('QA_MYSQL_DATABASE', 'question-db');
